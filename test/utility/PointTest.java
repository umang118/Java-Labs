...
class PointTest{
	 ...
	 * compare the return value of x() for p1 to 11.
	 * compare the return value of y() for p2 to 12.
	 ...
	 * compare the return value of x() for p1 to 15.
	 * compare the return value of y() for p2 to 16.
	 ...
	 * now use assertNotEquals to compare the 2 points.
	 * compare the return value of x() for p1 to 14.
	 * compare the return value of x() for p1 to 17.
	 * compare the return value of y() for p2 to 16.
	 ...
	 * compare the return value of x() for p1 to 9.
	 * compare the return value of y() for p2 to 8.
	 ...
	 * compare the return value of x() for p1 to 7.
	 * compare the return value of y() for p2 to 8.
	 * compare the return value of y() for p2 to 9.
	 */
	@Test
	...
	final void testToArray(){
		...
		assertNotEquals(p1.toArray(),p2.toArray());
		p1.bind(p2);
