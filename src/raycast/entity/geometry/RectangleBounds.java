...
public class RectangleBounds {
	 ...
	 * @return the current instance of this object
	 */
	public RectangleBounds move(Point p) {
		return move(p.x(), p.y());
	}
	...
	/**
	 * check if given {@link RectangleBounds} overlaps with current
	 * {@link RectangleBounds}
	 * 
	 * @see <a href="https://stackoverflow.com/a/32088787/764951">detecting
	 *      ovelaping rectangles</a>
	...
	/**
	 * check if given (x,y) with (w, h) overlaps with current
	 * {@link RectangleBounds}
	 * 
	 * @see <a href="https://stackoverflow.com/a/32088787/764951">detecting
	 *      ovelaping rectangles</a>
	...
	/**
	 * check if given {@link RectangleBounds} is with in this
	 * {@link RectangleBounds}
	 * 
	 * @param rect - given {@link RectangleBounds}
	...
	/**
	 * convert this object to a set of points starting from top right going
	 * clockwise.
	 * 
